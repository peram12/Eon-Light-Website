...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    hero_description: "ב-Eon Light, אנו הופכים רעיונות לפתרונות דיגיטליים חכמים ונושמים שמתפתחים עם העסק שלךתהאם אתם חולמים על אתר משלכם? פשוט צרו איתנו קשר ואנחנו נהפוך את הרעיונות שלכם למציאות.",
